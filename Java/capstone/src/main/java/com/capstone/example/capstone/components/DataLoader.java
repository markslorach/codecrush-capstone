...
//        Question questionIntermediate1 = new Question("How would you access the second element of a nested list my_list = [[1,2],[3,4]]?", "Think about what the first index position of any list is.", 1, 2, "'1' is actually the second index position of any list. So [1][1] will take us to the second position of the second list.");
...
//        Question questionIntermediate2 = new Question("What does the list comprehension [x for x in range(10) if x % 2 == 0] produce?", "Think about which values would correspond with 'x % 2 == 0'", 2, 2, "Starting at 0, only the even numbers between 0 and 9 will have no remainder if divided by 2");
//        questionRepository.save(questionIntermediate2);
//        Question questionAdvanced2 = new Question("What will print(2 * 3 ** 3 * 2) display?", "There is a power operator here.", 2, 3, "The power operator will run first, before the multiplication.");
...
//        Question questionAdvanced4 = new Question("What will print(all([True, 1, {3}])) display?", "Think about what all three parameters have in common.", 4, 3, "The all() function returns 'true' if parameters are true.");
...
//        Question questionIntermediate5 = new Question("What will the following code output: print('apple' > 'Apple')?", "Think about how a computer might interpret a string.", 5, 2, "The ASCII value of 'a' is greater than that of 'A'.");
//        questionRepository.save(questionIntermediate5);
//        Question questionAdvanced5 = new Question("In Python's Flask, which decorator is commonly used to route URL patterns to functions?", "No hint today. Good luck!", 5, 3, "Well done!");
...
//        Question questionIntermediate6 = new Question("What is the purpose of the else clause in a Python for-loop?", "This is slightly different to it's purpose in an if/else statement", 6, 2, "The 'else' allows for us to define multiple potential outcomes for our loop.");
//        questionRepository.save(questionIntermediate6);
//        Question questionAdvanced6 = new Question("What will the expression [1, 2, 3] * 2 produce in Python?", "What is the '*2' doing? What value is it working with?", 6, 3, "The list itself is multiplied by 2, not the values within.");
