...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Answer answerIntermediate1 = new Answer("my_list[1, 1] ", false, questionIntermediate5);
        answerRepository.save(answerIntermediate1);
        Answer answerIntermediate2 = new Answer("my_list[1][1] ", true, questionIntermediate5);
        answerRepository.save(answerIntermediate2);
        Answer answerIntermediate3 = new Answer("my_list[2][1] ", false, questionIntermediate5);
        ...
        Answer answerBeginner7 = new Answer("1", true, questionBeginner6);
        answerRepository.save(answerBeginner7);
        Answer answerBeginner8 = new Answer("3.3", false, questionBeginner6);
